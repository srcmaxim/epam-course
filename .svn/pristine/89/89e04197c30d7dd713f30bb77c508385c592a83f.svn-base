...
public class Part3Test {
	...
	@Test
	public void TestInputWithoutStop() {
		InputStream in = System.in;
		try {
			System.setIn(new ByteArrayInputStream(
	...
	public void TestInputWrong() throws UnsupportedEncodingException {
		InputStream in = System.in;
		try {
	...
	public void testGetString() {
		String fileName = Part3.getFileName();
		Part3.setFileName("wrong name");

		List<String> emptyList = Part3.getString();

		Assert.assertTrue(emptyList.isEmpty());

		Part3.setFileName(fileName);
	}
}